...
tooltip1  = ['<html><i>When more than one dataset are averaged together<br>'...
             'ERPLAB will create a weighted average ERP using the number<br>'...
             'of occurrences of each bin, within each dataset, as the weight.'];

set(handles.edit_help_avg1, 'tooltip',tooltip1);

%
% Name & version
%
version = geterplabversion;
set(handles.figure1,'Name', ['ERPLAB ' version '   -   AVERAGER GUI'])

            ...
            for ch = 1:nchan
                  if nlat==1   % 1 latency was specified
                        ...
                        elseif strcmpi(op1,'peakampbl')
                              ...
                              valx = localpeak(dataux, timex, 'Neighborhood',sampeak, 'Peakpolarity', polpeak, 'Sfactor',10, 'Measure','amplitude',...
                        ...
                        elseif strcmpi(op1,'peaklatbl')
                              ...
                              valx = localpeak(dataux, timex, 'Neighborhood', sampeak, 'Peakpolarity', polpeak, 'Sfactor', 10, 'Measure','peaklat',...
                                    'Peakreplace', localoptstr);
                        ...
                        elseif strcmpi(op1,'fpeaklat')
                              ...
                              valx = localpeak(dataux, timex, 'Neighborhood',sampeak, 'Peakpolarity', polpeak, 'Sfactor',10, 'Measure','fraclat',...

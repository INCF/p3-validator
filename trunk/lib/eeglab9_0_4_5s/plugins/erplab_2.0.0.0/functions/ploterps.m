...
if yauto
      ...
      [p1 p2 checkw] = window2sample(ERP, xlim(1:2) , fs, 'relaxed');
...
if istopo
      ...
      [tp1 tp2 checkw xlimc ] = window2sample(ERP, xlim(1:2) , fs, 'relaxed');
      ...
      for i=1:nch
            ...
            if ismeap
                  line(xlim(1:2),[0 0],'LineWidth',1,'Color',colorpl,'Marker','.','LineStyle','--','LineWidth',1);
                  line([0 0],ylim(1:2),'LineWidth',1,'Color',colorpl,'Marker','.','LineStyle','--','LineWidth',1);

...
elseif nargout==2 || nargout==3
      ...
      if A~=0
            ...
            if Ao~=0
                  ...
                  L = pmid;  % latency in (non-integer) samples
            ...
            if fracarearep==0
                  ...
                  error('ERPLAB says: Sorry, fractional area latency was not found because area values is zero.')
            end
      end
      
      varargout{2} = L/Fk; % rescale

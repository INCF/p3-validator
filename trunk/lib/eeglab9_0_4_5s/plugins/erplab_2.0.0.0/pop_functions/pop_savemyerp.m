...
try
        ...
        if isempty(ERP)
                msgboxText =  'Error: pop_savemyerp cannot save an empty ERP dataset';
                title = 'ERPLAB: pop_savemyerp() error:';
                errorfound(msgboxText, title);
                return
        end
        if ~iserpstruct(ERP)
                msgboxText =  'Error: pop_savemyerp only works with a valid ERP structure';
                title = 'ERPLAB: pop_savemyerp() error:';
                errorfound(msgboxText, title);
                return
        end
        ...
        serr = lasterror;
        msgboxText= ['ERPLAB found and error at: \n\n'...
                serr.message];
        title = 'ERPLAB: pop_savemyerp() error:';

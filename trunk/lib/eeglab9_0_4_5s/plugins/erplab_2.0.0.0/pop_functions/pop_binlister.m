...
% FORMAT   :
% 
% >> EEG = pop_binlister( EEG, bindescriptorfile, inputeventlistfile, 
% outputeventlistfile, resetflag, forbiddencodes, updatevents, workspace, 
% reportable );
% 
% EXAMPLE  :
% 
% >> EEG = pop_binlister( EEG, ?C:\Controls\Test\bdf_A.txt?, ?no?, ?C:
% \Controls\Test\SUBJ01.txt,0, [], 1, 0, 1);
% 
% INPUTS   :
% 
% EEG                   - input dataset. For non-eeg processes enter EEG=[]
...
%                         information to process, according to ERPLAB 
%                         format (see tutorial). Text version of the 
%                         EVENTLIST structure.
% outputeventlistfile 	- name of the text file will contain the upgraded 
%                         event information, according to ERPLAB format 
%                         (see tutorial). Text version of the EVENTLIST 
%                         structure.
% resetflag             - set all flags to zero before starting binlister 
%                         process. 1=reset 0:keep as it is.
% Forbiddencodes        - array of event codes (number) you do not want to 
%                         be included during the binlister processes.
% updatevents           - after binlister process you can move the upgraded 
%                         event information to EEG.event field. 1=update, 
%                         0=keep as it is. 
% workspace             - after binlister process you can copy the 
%                         resulting EVENTLIST structure to Matlab 
%                         workspace. 1=send Eventlist to workspace, 
%                         0=do not send.
...
%
%
% GUI: menuBinListGUI.m ; SUBROUTINE: binlister.m
%
%

% pop_importerpeventlist
% 
% PURPOSE  :	Apply imported eventlist from textfile to current ERP 
%               datset
% 
% FORMAT   :
% 
...
% EXAMPLE  :
% 
% >> ERP = pop_importerpeventlist( ERP, '/Users/etfoo/Documents/
% MATLAB/test.txt', 2 );                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
% 
% INPUTS   :
% 
...
% reventlist            - replace the current EVENTLIST structure.
% 				1:yes		0:send the EVENTLIST structure to workspace
% 
% OUTPUTS  :
% 
% ERP                   - EVENTLIST structure added to current ERP structure or 
%                         workspace
%
%
% GUI: eventlist2erpGUI.m ; SUBROUTINE: pasteeventlist.m
% 
%

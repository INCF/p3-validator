% pop_importeegeventlist
% 
% PURPOSE  :	Reads an event list from a text file and creates an 
% EVENTLIST structure. The EVENTLIST structure is attached to the EEG 
% structure. 
% 
% FORMAT   :
% 
...
% OUTPUTS  :
% 
% EEG           - EVENTLIST structure added to current EEG structure 
%               or workspace
%

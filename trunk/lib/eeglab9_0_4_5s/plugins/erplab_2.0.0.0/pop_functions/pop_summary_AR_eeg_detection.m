% [acce rej histoflags] = pop_summary_AR_eeg_detection(EEG, fullname)
%
...
if isempty(EEG.epoch)
        msgboxText = ['Permission denied:\n'...
                      'Summary_rejectfields() only works with epoched dataset.'];
...
if fidsumm>1
        ...
        com = sprintf('[acce rej histoflags ] = pop_summary_AR_eeg_detection(EEG,''none'');');
end

...
%   1. when a new release of BCILAB is made (new dependencies added, another MATLAB release), then for each operating system, 
%      a new project file is created manually as follows:
...
%      * if you want a console under Windows, you currently unfortunately have to copy over some flags from the UNIX version of the project file 
%        (copying everything that's not a directory works)

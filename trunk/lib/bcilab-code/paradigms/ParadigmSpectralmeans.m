classdef ParadigmSpectralmeans < ParadigmDataflowSimplified
    ...
    methods
        ...
        function defaults = preprocessing_defaults(self)
            defaults = {'IIRFilter',{[0.1 2],'highpass'}, 'EpochExtraction',[0.5 3.5], 'SpectralTransform',{'multitaper',true,false}, 'Resampling',100};
        end
        ...
        function features = feature_extract(self,signal,featuremodel)
            features = reshape(utl_picktimes(signal.data,featuremodel.wnds * signal.pnts / (signal.srate/2)),[],size(signal.data,3))';
        end

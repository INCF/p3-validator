...
% Last Modified by GUIDE v2.5 20-Jan-2012 20:18:51
...
shortlosses = {[], 'kld', 'nll', 'mcr', 'mae', 'mse', 'max', 'rms', 'bias', 'medse', 'auc', 'cond_entropy', 'cross_entropy', 'f_measure'};
...
set(hObject,'String',{'Automatically chosen', 'Kullback-Leibler divergence', 'Negative log-likelihood (NLL)', 'Mis-classification rate (MCR)', 'Mean absolute error (MAE)', ...
       'Mean square error (MSE)', 'Maximum absolute error', 'Root mean square error (RMSE)', 'Directed mean bias', 'Median square error', 'Area under ROC (AUC)', ...

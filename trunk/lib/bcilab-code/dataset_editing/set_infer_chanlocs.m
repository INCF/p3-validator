...
if (~all(isfield(locs,{'X','Y','Z'})) || all(cellfun('isempty',{locs.X}))) && ~isempty(locs)
    ...
    caps = {'resources:/Standard-10-5-Cap385.sfp','resources:/sccn_BEM_coregistered_128_v1.xyz','resources:/sccn_BEM_coregistered_256_v1.xyz','resources:/sccn_BEM_coregistered_128_v2.xyz'};
    schemes = {'10-20','sccn_128_v1','sccn_256_v1','sccn_128_v2'};
...
if any(empty_type)
    ...
    patterns = {'EO','EOG','EM','EMG','ECG','ECG','EX','EXG','GSR','GSR'};
